...
describe "performance_test_results/new.html.erb" do
  before(:each) do
    assign(:performance_test_result, stub_model(PerformanceTestResult,
  ...
  it "renders new performance_test_result form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => performance_test_results_path, :method => "post" do
